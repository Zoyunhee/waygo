...
export default function Join() {
    ...
    const sendCode = async () => { codeRef.current?.focus(); };
    const checkCode = async () => {
        const isValid = code === "123456";
        if (!isValid) { setShowCodeError(true); return; }
    };
...
const styles = StyleSheet.create({
    ...
    backBtn: {
        width: 32, height: 32, justifyContent: "center", alignItems: "center", marginRight: 4,
    },
    headerTitle: {
